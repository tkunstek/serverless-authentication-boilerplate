...
docker-compose up -d
SERVERLESS_STAGE=$SERVERLESS_STAGE SERVERLESS_REGION=$SERVERLESS_REGION SERVERLESS_PROJECT=$SERVERLESS_PROJECT LOCAL_DDB_ENDPOINT=$LOCAL_DDB_ENDPOINT node ./specs/dynamo.js
